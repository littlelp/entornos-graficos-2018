	...
	<div class= "container-fluid" id="contenidoedit">
		...
		<div class="row">
					...
					<div class="col-xs-8 col-sm-8 col-md-8 col-md-offset-1">
						<h2>Modificar contenido en pagina Principal</h2>
						<br>
						
</div>	
			<?php
			
				$sql1 = "select contenidoindex from web";
				...
				<br /><br />
					...
					<div class="col-xs-10 col-sm-10 col-md-10 col-md-offset-1">
						...
						<form action="modificar-contenido.php" method="post" enctype="multipart/form-data">
						...
						<div style="clear:both;"></div>
							...
							<textarea class="contenido" id="contenido" name="contenido"><?php echo $r["contenidoindex"];?></textarea>
